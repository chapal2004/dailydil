...
const products: IProductInput[]= [
  ...
  },
  {
    ...
    category: 'Jeans',
    brand: "Levi's",
    images: ['/images/p-01.jpg', '/images/p22-2.jpg'],
    tags: ['featured'],
    isPublished: true,
    price: 59.99,
    listPrice: 69.99,
  ...
  },
  {
    ...
    category: 'Jeans',
    brand: 'Essentials',
    images: ['/images/p-02.jpg', '/images/p23-2.jpg'],
    tags: ['best-seller'],
    isPublished: true,
    price: 38.9,
    listPrice: 45,
  ...
  },
  {
    ...
    images: ['/images/p-01.jpg', '/images/p02-2.jpg'],
    tags: ['todays-deal'],
    isPublished: true,
    price: 69.99,
    listPrice: 100,
  ...
  {
    name: 'Face cream',
    slug: toSlug('Face Cream'),
    category: 'Jeans',
    brand: 'Wrangler',
    images: ['/images/p-01.jpg', '/images/p26-2.jpg'],
    tags: ['best-seller', 'todays-deal'],
    isPublished: true,
    price: 81.78,
    listPrice: 149.99,
  ...
  // Watches
  {
    ...
    brand: 'Seiko',
    images: ['/images/p-02.jpg', '/images/p-96.jpg'],
    tags: ['new-arrival'],
    isPublished: true,
    price: 530.0,
    listPrice: 0,
  ...
  },
  {
    ...
    category: 'Wrist Watches',
    brand: 'Seiko',
    images: ['/images/caro2.png', '/images/caro1.png'],
    tags: ['featured'],
    isPublished: true,
    price: 375.83,
    listPrice: 400,
...

  {
    ...
    category: 'Shoes',
    brand: 'ASICS',
    images: ['/images/p-01.jpg', '/images/p-02.jpg'],
    tags: ['new-arrival', 'featured'],
    isPublished: true,
    price: 179.95,
    listPrice: 200,
  ...
  },
  {
    ...
    category: 'Shoes',
    brand: 'Generic',
    images: ['/images/p-02.jpg', '/images/p-01.jpg'],
    tags: ['best-seller', 'todays-deal'],
    isPublished: true,
    price: 32.99,
    listPrice: 80,
...
const data: Data = {
   products,
    headerMenus: [
        ...
        {
            name: "Feature Product's",
            href: '/search?tag=featured',
        },
        {
            name: "Best Sellers ",
            href: '/search?tag=best-sellar',
        },
        {
